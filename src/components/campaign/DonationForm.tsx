...
function DonationForm({
  ...
  return (
    <section className={cn("py-6  md:px-16", !isExpanded && "hidden")}>
      <h2 className="text-2xl font-bold text-center">Select Donation Amount</h2>
      <DonationOptions
      ...
      <div className="px-10 py-2 flex flex-col items-center gap-4">
        ...
        <Button
          className="rounded-full flex gap-3 items-center text-2xl h-12 max-w-80"
          variant="outline"
