...
function getCampaignData(searchParams: URLSearchParams): CampaignData {
    ...
    const numberParameters: string[] = ["donors", "currentAmount", "targetAmount", "targetDate"];
...
function getDonationOptions(searchParams: URLSearchParams): DonationOption[] {
    const donationOptionValues: number[] = searchParams.getAll("donationOptionValue").map((donationOptionValue) => parseInt(donationOptionValue));
    const donationOptionDescriptions: string[] = searchParams.getAll("donationOptionDescription");
